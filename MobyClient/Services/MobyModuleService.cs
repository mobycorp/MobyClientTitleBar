...
namespace MobyClient.Services;

public class MobyModuleService {
	...
	///		Default constructor.
	/// </summary>
	public MobyModuleService () {

		Modules = new List<MobyModule>(XmlHelper.GetMobyModules ());
	}
	...
	public List<MobyModule> Modules { get; set; }
