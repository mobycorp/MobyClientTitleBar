...
public partial class PageSharedContent : ContentPage {

	#region Constructors

	public PageSharedContent (SharedContentViewModel sharedContentViewModel) {

		Guard.IsNotNull (sharedContentViewModel);

		InitializeComponent ();

		BindingContext = sharedContentViewModel;
	}
